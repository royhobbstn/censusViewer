...
/*
    ...
    "ageless10": {
        ...
        "section": "Age",
        "table": "B01001",
        "numerator": ["B01001003", "B01001004", "B01001027", "B01001028"],
        "denominator": ["B01001001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "ageless18": {
        ...
        "section": "Age",
        "table": "B01001",
        "numerator": ["B01001003", "B01001004", "B01001027", "B01001028", "B01001005", "B01001006", "B01001029", "B01001030"],
        "denominator": ["B01001001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "age18to24": {
        ...
        "section": "Age",
        "table": "B01001",
        "numerator": ["B01001007", "B01001008", "B01001009", "B01001010", "B01001031", "B01001032", "B01001033", "B01001034"],
        "denominator": ["B01001001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "age25to34": {
        ...
        "section": "Age",
        "table": "B01001",
        "numerator": ["B01001011", "B01001012", "B01001035", "B01001036"],
        "denominator": ["B01001001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "age35to44": {
        ...
        "section": "Age",
        "table": "B01001",
        "numerator": ["B01001013", "B01001014", "B01001037", "B01001038"],
        "denominator": ["B01001001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "age45to64": {
        ...
        "section": "Age",
        "table": "B01001",
        "numerator": ["B01001015", "B01001016", "B01001017", "B01001018", "B01001019", "B01001039", "B01001040", "B01001041", "B01001042", "B01001043"],
        "denominator": ["B01001001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "nohsdipl": {
        ...
        "section": "Education",
        "table": "B15003",
        "numerator": ["B15003002", "B15003003", "B15003004", "B15003005", "B15003006", "B15003007", "B15003008", "B15003009", "B15003010", "B15003011", "B15003012", "B15003013", "B15003014", "B15003015", "B15003016"],
        "denominator": ["B15003001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
        "usezeroasnull": "no",
    ...
    "hsgradsc": {
        ...
        "section": "Education",
        "table": "B15003",
        "numerator": ["B15003017", "B15003018", "B15003019", "B15003020", "B15003021"],
        "denominator": ["B15003001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "bachlhghr": {
        ...
        "section": "Education",
        "table": "B15003",
        "numerator": ["B15003022", "B15003023", "B15003024", "B15003025"],
        "denominator": ["B15003001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "citzbirth": {
        ...
        "section": "Citizenship",
        "table": "B05001",
        "numerator": ["B05001002", "B05001003", "B05001004"],
    ...
    "insured": {
        ...
        "section": "Insurance",
        "table": "B27001",
        "numerator": ["B27001004", "B27001007", "B27001010", "B27001013", "B27001016", "B27001019", "B27001022", "B27001025", "B27001028", "B27001032", "B27001035", "B27001038", "B27001041", "B27001044", "B27001047", "B27001050", "B27001053", "B27001056"],
        "denominator": ["B27001001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
        "usezeroasnull": "no",
    ...
    "uninsured": {
        ...
        "section": "Insurance",
        "table": "B27001",
        "numerator": ["B27001005", "B27001008", "B27001011", "B27001014", "B27001017", "B27001020", "B27001023", "B27001026", "B27001029", "B27001033", "B27001036", "B27001039", "B27001042", "B27001045", "B27001048", "B27001051", "B27001054", "B27001057"],
        "denominator": ["B27001001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "k8": {
        ...
        "section": "Education",
        "table": "B14001",
        "numerator": ["B14001004", "B14001005", "B14001006"],
        "denominator": ["B14001002"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
        "usezeroasnull": "no",
    ...
    "inpoverty": {
        ...
        "section": "Poverty",
        "table": "C17002",
        "numerator": ["C17002002", "C17002003"],
        "denominator": ["C17002001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
        "usezeroasnull": "no",
    ...
    "inpov150": {
        ...
        "section": "Poverty",
        "table": "C17002",
        "numerator": ["C17002002", "C17002003", "C17002004", "C17002005"],
        "denominator": ["C17002001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
    ...
    "disabled": {
        ...
        "section": "Disability",
        "table": "B18101",
        "numerator": ["B18101004", "B18101007", "B18101010", "B18101013", "B18101016", "B18101019", "B18101023", "B18101026", "B18101029", "B18101032", "B18101035", "B18101038"],
        "denominator": ["B18101001"],
        "type": "percent",
        "minval": "0",
        "mininc": "0.01",
        "usezeroasnull": "no",
    ...
    "cbhm": {
        ...
        "section": "Housing",
        "table": "B25101",
        "numerator": ["B25101006", "B25101010", "B25101014", "B25101020", "B25101022"],
        "denominator": ["B25101002"],
        "type": "percent",
        "minval": "0",
        "mininc": ".01",
        "usezeroasnull": "no",
