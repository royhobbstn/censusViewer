...
export function thunkUpdateClusters(pole, current_zoom, current_bounds) {
    return (dispatch, getState) => {
        ...
        // TODO this is where I left off.  Tract 2016 has been generated.
        // TODO lambda will need to return a list of cluster ids it returned, along with the actual data
        ...
        const root = 'http://52.26.191.230:8081/retrieve?';
        // const root = 'https://34suzrhb22.execute-api.us-west-2.amazonaws.com/dev/retrieve?';

        const url = `${root}expression=${expression}&dataset=${source_dataset}&sumlev=${sumlev}&pole_lat=${pole.lat}&pole_lng=${pole.lng}&current_zoom=${current_zoom}&current_bounds=${bounds}`;
        ...
        // const moe_url = `https://34suzrhb22.execute-api.us-west-2.amazonaws.com/dev/retrieve?expression=${moe_expression}&dataset=${source_dataset}&sumlev=${sumlev}&pole=${pole}&current_zoom=${current_zoom}&current_bounds=${bounds}&moe=true`;
